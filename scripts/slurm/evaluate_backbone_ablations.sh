#!/bin/bash
#SBATCH --job-name=faba-backbone-eval
...
#SBATCH --output=logs/backbone_eval_%j.out
#SBATCH --error=logs/backbone_eval_%j.err

# =============================================================================
# Evaluate backbone ablation experiments after training completes
#
# Usage:
...
echo "=== Evaluating backbone ablation experiments ==="
echo "Start: $(date)"
echo ""
